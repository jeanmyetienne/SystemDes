...
<body>
            ...
            <h1>MASTER SCHEDULE- SPRING 2022</h1>
    ...
    <tbody>
        ...
        <?php
            ...
            $sql = "SELECT CRN, Section, Course_Id, Course_Name, Department_Name, Day, Start_Time, End_Time, Semester, Year, Building, Room_Number, Professor_First_Name, Professor_Last_Name, Available_Seats, Total_Seats FROM MSSPRING2022";
