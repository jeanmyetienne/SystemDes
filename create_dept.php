...
?>
        ...
        <div class="w3-panel w3-left w3-white" >
            <form class="w3-container" action = "dept_validate.php" method = "post">
                ...
                <input class="w3-input" type="text" name="Dept_Name">
                <br>
                ...
                <br><br>
                <label class="w3-label w3-white"><b>Dept_ID</b></label>
                <input class="w3-input" type="text" name="Dept_ID">
                </input>
                <div>
                    <button class="w3-btn w3-brown" type="submit">Create</button>
                </div>
            </form>
        </div>
</div>
