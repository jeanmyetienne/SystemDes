...
$sql = "Select first_name, last_name, date_of_birth, Email, Zipcode, Password
        from Users
...
if (isset($_POST['changeInfo'])) {
  ...
  $updatedNumber = $_POST['Zipcode'];
  $sql = "UPDATE Users SET first_name = '$updatedFirstname', last_name = '$updatedLastname', date_of_birth = '$updatedDob',
  Zipcode = '$updatedNumber' WHERE Email = '$username'";
...
if (isset($_POST['changePassword'])) {
  ...
  $sql = "UPDATE User_Login SET Password = '$updatedPass' WHERE Email = '$username'";
  if (mysqli_query($conn, $sql)) {
...
?>
  ...
  <li><button class="w3-button w3-brown" onclick="document.getElementById('id01').style.display='block'">Update</button> </li>
</ul>
    <ul class="w3-ul">
    <li><h3>Email</h3></li>
  ...
  <li><button class="w3-button w3-brown" onclick="document.getElementById('id02').style.display='block'">Change</button> </li>
</ul>
    </div>
    ...
    <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:450px">
      ...
      <hr>
        ...
        <form class="w3-container" id = "changeInfo" method = "post" action="?" onSubmit = "validate();">
          ...
          <input class="w3-input signup <?php echo $_SESSION['User_Type'] != 'Admin' ? 'w3-light-grey' : '' ?>" type="text" placeholder="Enter First Name" id = "first_name" name = "first_name" onchange = "validateFirstName(this.value);" value = "<?php echo $firstname ?>" <?php echo isset($error_firstname_css) ? 'style="'. $error_firstname_css .'"' : '' ?>
          <?php echo $_SESSION['User_Type'] != 'Admin' ? 'readonly' : '' ?>>
          ...
          <input class="w3-input signup <?php echo $_SESSION['User_Type'] != 'Admin' ? 'w3-light-grey' : '' ?>" type="text" placeholder="Enter Last Name" id = "last_name" name = "last_name" onchange = "validateLastName(this.value);" value = "<?php echo $lastname ?>" <?php echo isset($error_lastname_css) ? 'style="'. $error_lastname_css .'"' : '' ?>
          <?php echo $_SESSION['User_Type'] != 'Admin' ? 'readonly' : '' ?>>
          ...
          <input class="w3-input signup <?php echo $_SESSION['User_Type'] != 'Admin' ? 'w3-light-grey' : '' ?>" type="date" placeholder="Enter dob" id = "date_of_birth" name = "date_of_birth" value = "<?php echo $dob ?>" <?php echo isset($error_dob_css) ? 'style="'. $error_dob_css .'"' : ''?>
          <?php echo $_SESSION['User_Type'] != 'Admin' ? 'readonly' : '' ?>>
          ...
          <input class="w3-input signup" type="text" placeholder="Enter Zip Code" id = "number" name = "number" onchange = "validateZipcode(this.value);" value = "<?php echo $number ?>" <?php echo isset($error_zipcode_css) ? 'style="'. $error_zipcode_css .'"' : ''?>>
          <span class = "errormsg" id="errorZipcode" style = "color: #CD2627"> <?php echo isset($errorZipcode) ? $errorZipcode : ''?> </span> 
      ...
      <div class="w3-center w3-container w3-border-top w3-padding-16 w3-light-grey">
        ...
        <input type="submit" class="w3-margin-left w3-button w3-brown" id = "submit1" name = "changeInfo" value = "Save Changes">
      </div>
 </form>
    </div>
  </div>
