...
if (isset($_GET['Admin_name'])) {
    $_SESSION['Advisor_Name'] = $_GET['Admin_name'];
}
...
?>
        ...
        <div class="w3-container">
            ...
            <h2><?php echo $_SESSION['Advisor_Name']; ?></h2>
        ...
        <div>
            <form class="w3-container" id="addMemForm" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" >
                    ...
                    <div>
                        <input class="w3-btn w3-brown" type="submit" name="addbutton" value="Add Student" />
                    </div>
            ...
            <div class="w3-container" style="float:right; width:50%">
                <table class="w3-table-all w3-margin-top" id="myTable">
                    ...
                    <?php getStuByAdvisorTable($_SESSION['Faculty_ID']) ?>
                </table>
            </div>
                </form>
        </div>
