...
?>
    ...
    <div class="w3-row-padding w3-margin-top w3-margin-top w3-animate-top" style = "color:black"> 
        <!-- Start Card -->
        <a class="w3-quarter" style="text-decoration: none;" href="create_account.php">
        ...
        <!-- End Card -->
        <!-- Start Card
        <a class="w3-quarter" style="text-decoration: none;" href="search_account.php">
        ...
        <!-- End Card -->
        <!-- Start Card -->
        <a class="w3-quarter" style="text-decoration: none;" href="delete_account.php">
          <div class="w3-center w3-hover-khaki icons">
            <i class=" fa-5x" aria-hidden="true"></i>
            <div class="w3-container">
              <h3>Change/Delete User</h3>
            </div>
          </div>
        </a>
        <!-- End Card -->
