...
<html>
    ...
    <span> Signed in as <?php echo $_SESSION['Email']?> </span>
...
<div class="w3-display-container w3-center w3-wide image w3-grayscale-min">
  ...
  <h2 class = "w3-xxxlarge">Hogwats Registration System</h2>
 ...
 <div class="w3-display-bottommiddle w3-text-white w3-center w3-hide-large" style = "margin-bottom:10px">
    <h2 class="w3-xxlarge w3-hide-large">Hogwats Registration System</h2>
    <h2 class="w3-xxlarge w3-hide-large">Hogwats University</h2>
  </div>
</div>
    <!-- Cards start -->
    <div class="w3-row-padding w3-margin-top">
        <!-- Start Card -->
        <a class="w3-quarter" style="text-decoration: none;" href="department_report.php">
        ...
        <!-- End Card -->
        <!-- Start Card -->
        <a class="w3-quarter" style="text-decoration: none;" href="section_report.php">
          <div class="w3-center w3-hover-brown icons">
            <i class=" fa-5x" aria-hidden="true"></i>
            <div class="w3-container">
